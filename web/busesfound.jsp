...
<html>
    ...
    <body >
        ...
        <%
            ...
            String uname="khwaja";
            String pwd="khwaja";
            String tid_no=""+session.getAttribute("tidnum");
            try {
              ...
              <div class='table'>
                  ...
                  <table>
                    <tr>
                        ...
                        <th><%=rs.getString("duration")%>hours</th>
                ...
                <table>
                    <tr>
                        <th rowspan="2">
                            <input type="button" class="btn btn-light" id="selectedBus" onclick="click_fn(this)"  value="View Seats" name=<%=rs.getString("bid")%>/>
                        </th>
        ...
        window.location="http://localhost:8084/MandalaBus/view_seats.jsp?bidnumber="+checked_bus;
      }
    </script>
    </body>
</html>