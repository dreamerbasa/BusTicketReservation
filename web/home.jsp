...
<div class="jumbotron text-center" style="background-image: url(https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80); background-size: 100%;">
  ...
  <form name="homeform" class="form-inline" action="/MandalaBus/nobuses.jsp" method="post">
      <div class="input-group"><table>
              ...
              <td><input type="date" class="form-control" name="jdate" min= <%=dtf.format(now)%> value="" required/> </td></tr></table>
...
<div class="text-right" style="padding-right: 20px;">
    <button type="button" class="btn btn-warning" onclick="newLocation()">Cancel Tickets</button>
 <script>
    function newLocation() {
        window.location="http://localhost:8084/MandalaBus/CancelPage.jsp";
    }
  </script>
</div>
